...
# Keep standalone libsharp linking configurable. Legacy HEALPix builds may
# set SHARP_LINK empty; other installations can supply a library search path.
SHARP_LINK ?= -lsharp
...
export LINK := -L../commander -L../include -lcommander -lcommander_healpix $(HEALPIX_LINK) $(SHARP_LINK) $(CFITSIO_LINK) $(LAPACK_LINK) $(LDFLAGS) $(F90OMPFLAGS)
